...
const BookingForm = () => {
    ...
    return (
        <section className="flex flex-row justify-center lg:justify-start text-white order-3 lg:order-2">
            <form onSubmit={handleSubmitForm} className="flex flex-col gap-y-4 border-[1.5px] border-white py-5 lg:py-10 px-5 rounded-xl w-[380px]">
                ...
                <div className="flex flex-row justify-between pb-10">
                    <input className='text-[12px] text-center text-white bg-transparent border-[1px] rounded py-2 sm:px-2 ' type="datetime-local" label="name" onChange={(e) => setCurrentDateTime(e.target.value)} value={currentDateTime} />
