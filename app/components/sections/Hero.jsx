        ...
        <section className="relative">
            ...
            <div className="relative h-screen flex flex-col justify-between pt-5 pb-20 px-20 ">
                ...
                lg:translate-y-[-40px] xl:translate-y-[0px] order-2">
                    <p className="text-white text-[18px] mt-5 lg:mt-0 px-24 lg:px-0 lg:w-[500px] order-2 lg:order-1"><span className="hidden lg:flex">Our mission is to provide exceptional grooming services in a relaxed and friendly environment.</span> Whether you're here for a classic haircut, a modern fade, or a clean shave, our skilled barbers are dedicated to ensuring you leave looking and feeling your best.</p>
                    <h1 className="text-white text-[70px] lg:text-[58px] xl:text-[78px] text-center lg:text-right font-semibold lg:leading-[80px] lg:w-[900px] uppercase order-1 lg:order-2 ">Where tradition <br />meets modern style.</h1>
                </div>
            </div>
        </section>
    )
